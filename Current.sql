...
INSERT INTO `integrity` VALUES (1,4,172);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `RESTRICT_INSERT` BEFORE INSERT ON `integrity` FOR EACH ROW BEGIN  
 SIGNAL SQLSTATE '45000'  
 SET MESSAGE_TEXT = "insertion is prohibited in this  table";  
 END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `RESTRICT_DELETE` BEFORE DELETE ON `integrity` FOR EACH ROW BEGIN 
...
INSERT INTO `voter` VALUES ('16820020678',NULL,'05433453732',22,'Kadifekale','atahanekici@hotmail.com'),('22089345638',NULL,'05273382894',36,'Buca','berkay.omerbas@gmail.com'),('60789024567',NULL,'+07894356021',45,'LimonTepe','yigitdemircan@gmail.com');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `ID_CONTROL` BEFORE INSERT ON `voter` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `INSERT_COUNT` AFTER INSERT ON `voter` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `DELETE_COUNT` AFTER DELETE ON `voter` FOR EACH ROW BEGIN
...
/*!50106 DROP EVENT IF EXISTS `TIME_OUT` */;
DELIMITER ;;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `TIME_OUT` ON SCHEDULE EVERY 10 MINUTE STARTS '2020-04-17 00:00:00' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Removes Voters codes every 10 minutes' DO UPDATE voter.voter SET voter.Code = null */ ;;
...
-- Dump completed on 2020-04-17 19:21:21
